...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("09/04/2022"), "Partiu viagem", "Vou viajar para Serra Verde. Abraços!", mariah  );
        Post post2 = new Post(null, sdf.parse("05/04/2022"), "Bom dia", "Acordei feliz hoje!", mariah);
